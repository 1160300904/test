 ...
 * 
 * This class runs the GraphInstanceTest tests against ConcreteVerticesGraph, as well as tests for
...
public class ConcreteVerticesGraphTest extends GraphInstanceTest {
  ...
  public void testConcreteVerticesGraphToString() {
    ...
    String answer1 =
        "Vertex: 1  Outward-edges: [10,2] [20,3] \n" + "Vertex: 2  Outward-edges: [60,4] \n"
  ...
  // TODO
  /*
   * L: 不同种类泛型 add()和remove()中输入是否为null： 是，否 target域是否为空： 是，否 source是否为null： 是，否
   */
  ...
  public void testGetTargetsAndGetIterator() {
    ...
    v1.addTarAndWei(taw1);
    v1.addTarAndWei(taw2);
    v1.addTarAndWei(taw3);
    v1.addTarAndWei(taw4);
  ...
  public void testAddAndRemove() {
    ...
    v1.removeTarAndWei(taw1);
    v1.removeTarAndWei(taw2);
    v1.removeTarAndWei(taw3);
    assertTrue(taw4.getTarget().equals(l1.get(3).getTarget()));
    assertEquals(taw4.getWeight(), l1.get(3).getWeight());

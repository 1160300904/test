...
public class GraphStaticTest {
    ...
    public void testDifferetnTypes() {
    	...
    	Integer one=1;Integer two =2;Integer three=3;
    	g1.add(one);g1.add(two);g1.add(three);
    	g1.set(one, two, 1);g1.set(three, two, 3);
    	Map<Integer,Integer> set1=new HashMap<>();
    	set1.put(1, 1);set1.put(3,3);
    	assertEquals(set1,g1.sources(two));
    	
    	Graph<Double> g2=Graph.empty();
    	Double done=1.1;Double dtwo=2.2;Double dthree=3.3;
    	g2.set(done, dtwo, 1);

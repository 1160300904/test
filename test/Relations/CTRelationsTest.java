...
public class CTRelationsTest {
     ...
     * relation has existed in current relations, or not. 3.deleRelation(): relation
     * has existed in current relations, or not. 4.relatedTo(): the relation between
     * the inputs has existed in current relations, or not.
     */

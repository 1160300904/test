...
public class TestAPI {
    /*
     * Testing strategy: 1.getObjectDistributionEntropy 1）输入的多轨道系统，所有物体是否排在一条轨道上
     * 2）熵值结果==0,<1,>1 2.getAtomDifference 1）二者轨道数的区别：第一个轨道少，第二个轨道少，两者一样多
     * 2）两者轨道上物体数目的差别：第一个少，第二个少，两者一样多 3）两者是否有上面一个物体也没有的轨道 3.getPersonalAppDifference
     * 1）二者轨道数的区别：第一个轨道少，第二个轨道少，两者一样多 2）两者轨道上物体数目的差别：第一个少，第二个少，两者一样多
     * 3）两者是否有上面一个物体也没有的轨道 4）物体差异上：某条轨道上，第一条轨道上的物体全包含于第二条 第一条轨道上的物体全包含于第二条
     * 第一条轨道上的物体∩第二条的==空 第一条轨道上的物体∩第二条的!=空 4.getRaceGameDifference
     * 1）二者轨道数的区别：第一个轨道少，第二个轨道少，两者一样多 2）两者轨道上物体数目的差别：第一个少，第二个少，两者一样多
     * 3）两者是否有上面一个物体也没有的轨道 4）物体差异上：某条轨道上，第一条轨道上的物体全包含于第二条 第一条轨道上的物体全包含于第二条
     * 第一条轨道上的物体∩第二条的==空 第一条轨道上的物体∩第二条的!=空 5.getDifference
     * 1）输入的轨道系统类型：原子结构/app生态系统/竞赛系统
     */
    @Test

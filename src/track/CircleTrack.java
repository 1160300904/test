...
/**
 * This is an implementation of interface Track.
 * It's a IMMUTABLE class.
 */
public class CircleTrack implements Track {

	private double radius;
	/*Abstract Function:
	 * 	1.radius represents the radius of the track.
	 */
	/*Rep Invariant:
	 * 	1.radius must greater than zero. (radius>0)
	 */
	/*Safe from Rep Exposure:
	 * 	1.all fields are private.
	 * 	2.all return type and parameter type of all method are immutable.
	 */
	/**

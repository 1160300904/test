...
public interface TrackFactory {
	 ...
	 * @return		An instance of Track<E> which has the radius of {@code radius}.
	 * 				If radius<=0, then the method returns null.
	 */
	 ...
	 * @return				An instance of Track<E> which has the radius of {@code radius}, and all the

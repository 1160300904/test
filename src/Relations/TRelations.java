...
/**
 * This is a class represents the relations between PhysicalObjects in a
...
public class TRelations<E> {
    ...
    /*
     * Abstract Function: 1.graph represents a relation graph. 2.if two objects of
     * type E are related in CircularOrbit, then there will be an edge in the graph
     * that connects these objects.
     */
    /*
     * Rep Invariant: 1.objects cann't have relations with themselves.
     */
    /*
     * Safe from rep exposure: 1.all fields are private; 2.all method returns void
     * or primitive types. 3.all parameters in methods are of immutable type E.
     */
    ...
    /**
     * Add a relation between two objects. If the relation has existed in current
    ...
    /**
     * Delete a relation between two objects. If the relation doesn't exist in
    ...
    /**
     * Get the target vertices with directed relations from a source vertex and the

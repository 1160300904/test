...
/**
 * This is a class represents the relations between PhysicalObjects in a CircularOrbit.
 * This is MUTABLE.
 *
 */
public class TRelations<E> {
	...
	/*Abstract Function:
	 * 	1.graph represents a relation graph.
	 * 	2.if two objects of type E are related in CircularOrbit, then there will be an edge in
	 * 		the graph that connects these objects.
	 */
	/*Rep Invariant:
	 * 	1.objects cann't have relations with themselves.
	 */
	/*Safe from rep exposure:
	 * 	1.all fields are private;
	 * 	2.all method returns void or primitive types.

...
/**
 * This is a class represents the relations between CentralObject and PhysicalObject in a CircularOrbit.
 * This is MUTABLE.
...
public class CTRelations<L,E> {
	...
	/*Abstract function:
	 * 	1.central represents the CentralObject in this CircularOrbit.
	 * 	2.phyobj represents a list of PhysicalObject that are related with the CentralObject.
	 * 	3.all the objects and only the objects in phyobj are related with the CentralObject.
	 */
	/*Rep Invarinat:
	 * 	1.each objects in phyobj must not be null.
	 */
	/*Safe from Rep exposure:
	 * 	1.all fields are private.
	 * 	2.getCentralObject() method returns a immutable type L.
	 * 	3.getPhysicalObject() method returns an unmodifiable view of set phyobj.
	 * 	4.Other functions' parameter are all of immutable type L, and the return value are primitive type
	 * 		boolean.
	 */
	void checkRep() {
		for (E e:phyobj) {
	...
	/**
	 * Add a relation between CentralObject and e.
	 * If the relation has existed in current relations, then this class is not modified.
	...
	/**
	 * Delete a relation between CentralObject and e.
	 * If the relation doesn't exist in current relations, then this class is not modified.

...
class ConcretePersonalApp implements PersonalApp {
	...
	/*Abstract function:
	 * 	1.name represents the name of the personal app.
	 * 	2.company represents the company of the personal app.
	 * 	3.version represents the version of the personal app.	
	 * 	4.functionality represents the functionality of the personal app.
	 * 	5.businessarea represents the business area of the personal app.
	 */
	/*Rep Invariant:
	 * 	1.all the string fields must not be empty string.
	 */
	/*Safe from rep exposure.
	 * 	1.all fields are private.
	 * 	2.all return type and parameter type of the methods are all immutable.
	 */
	void checkRep() {
	 ...
	 */
	ConcretePersonalApp(String name,String company,String version,

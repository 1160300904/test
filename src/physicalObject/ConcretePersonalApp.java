...
class ConcretePersonalApp implements PersonalApp {
    ...
    /*
     * Abstract function: 1.name represents the name of the personal app. 2.company
     * represents the company of the personal app. 3.version represents the version
     * of the personal app. 4.functionality represents the functionality of the
     * personal app. 5.businessarea represents the business area of the personal
     * app.
     */
    /*
     ...
     */
    ConcretePersonalApp(String name, String company, String version, String functionality, String businessarea) {
    ...
    public boolean equals(Object o) {
        ...
        return o1.getName().equals(this.getName()) && (o1.getCompany()).equals(this.company)
                && o1.getVersion().equals(this.version) && (o1.getFunctionality()).equals(this.functionality)

...
class ConcreteAthlete implements Athlete {
	...
	/*Abstract function:
	 * 	1.name represents the name of the athlete.
	 * 	2.number represents the number of the athlete.
	 * 	3.nation represents the nation of the athlete.
	 * 	4.age represents the age of the athlete.
	 * 	5.bestscore represents the best score of the athlete.
	 */
	/*Rep Invariant:
	 * 	1.name cannot be empty string.
	 * 	2.number must be a positive number.
	 * 	3.nation cannot be empty string.

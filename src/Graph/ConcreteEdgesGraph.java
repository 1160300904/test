...
public class ConcreteEdgesGraph<L> implements Graph<L> {
     ...
     * 	vertices represents the vertices of the edge.
     * 	edges represents the edge of the edge.
     */
    /*Representation invariant:
     * 	if vertices is empty, then edges must be empty.
     * 	there shouldn't be multiple edges between two vertices.
     * 	the two vertices of an edge in edges must exists in the rep vertices.
     */
    /*Safety from rep exposure:
     * 	all fields are private and final.
     * 	L is immutable type, so it's fine to input a parameter without defensive copy.
     * 	vertices() returns an unmodifiable view of the set 
    ...
    @Override public boolean remove(L vertex) {
        if(vertices.contains(vertex)) {
        	vertices.remove(vertex);Edge<L> edge;
    ...
    @Override public String toString() {
    	...
    	for(Edge<L> edge:edges) {
    		answer.append("["+edge.getSource().toString()+","
    								+edge.getWeight()+","+edge.getTarget().toString()+"] ");
    	}
    	answer.append('\n');
 ...
 * an Edge instance represent an edge of a graph.

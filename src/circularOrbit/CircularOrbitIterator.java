...
/**
 * An iterator of this circular orbit system, which can be used to iterate the
 * system in a order that you get the objects in the inner tracks first, then
 * the outer side tracks. Then, on each track, you will get objects has a
...
public class CircularOrbitIterator<L, E> implements OrbitIterator<L, E> {
    ...
    /*
     * Abstract function: 1.orbit is the orbit system you want to iterate. 2.obj is
     * the objects on tracks. 3.objlist is a list contains all the objects on the
     * tracks. 4.iter is a iterator of objlist.
     */
    /*

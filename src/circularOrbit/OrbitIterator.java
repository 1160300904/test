 ...
 * the system in a order that you get the objects in the inner tracks first, then the outer side tracks. 
 * Then, on each track, you will get objects has a smaller degree on the coordinate system.

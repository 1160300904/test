...
public class PersonalAppHandler {
    ...
    private String handleApp(String str) {
        ...
        if (elements[2].matches("([[a-z][A-Z][0-9]-_\\.]+)") == false) {
            ret = "The version of app should be a label, " + "only \'-\', \'_\', \'.\', letter and number is allowed";
            System.out.println(ret);
            return ret;
        }
        ...
        if (elements[3].matches("\"[[a-z][A-Z][0-9]\\s]+\"") == false) {
            ret = "The functionality of app should be a sentence, " + "only space, letters, numbers may appears.";
            System.out.println(ret);
            return ret;
        }

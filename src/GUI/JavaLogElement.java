...
public class JavaLogElement implements Comparable<JavaLogElement>{
	...
	/*Abstract functions:
	 * 	1.time means when this log element happens
	 * 	2.oe means is this log an operation or an exception
	 * 	3.detoe means the detail of this operation or exception
	 * 	4.message means the message of this log element
	 * 	5.sourceclass means the source class of this log element
	 * 	6.sourcemethod means the source method of this log element
	 * 	7.answer means the response of the operation or exception
	 */
	/*Rep Invariant:
	 * 	none.
	 */

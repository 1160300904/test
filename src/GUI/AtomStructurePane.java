...
/**
 * This is the class of pane of atom structure. The circular orbit of atom
 * structure will be drawn on this pane.
 * 
...
public class AtomStructurePane extends CircularOrbitPane<Nucleus, Electron> {
    ...
    /*
     * Abstract function: 1.atomstruc is the instance of AtomStructure, which will
     * provide informations for the pane to draw. 2.transition is a button to
     * transit the electrons on tracks 3.filechooser and stage is used for user to
     * choose the initial file. 4.atomhandler is the exception handler of atom
     * structure.
     */
    /*
     * Rep Invariant: none.
    ...
    AtomStructurePane() {
        ...
        this.initBut.setOnAction(e -> {
             ...
             * this.atomstruc.initWithFile(file); } catch (FileNotFoundException e1) {
             * e1.printStackTrace(); }
             */
            File file;
        ...
        this.remObjBut.setOnAction(e -> {
            ...
            Map<Electron, Double> electronmap = this.orbit.getThetas();
            Electron deleele = null;
        ...
        setOrbit.setOnAction(e -> {
            ...
            LogRecord lr = new LogRecord(Level.INFO, "Operation" + ",SetOrbit," + "set orbit" + ",succeed");
            this.log.log(lr);
            this.logsaver.add(lr);
        });
        ...
        this.transition.setOnAction(e -> {
            ...
            double theta = s.nextDouble();
            int restracknum = s.nextInt();
            int tartracknum = s.nextInt();
            ...
            s.close();
            LogRecord lr = new LogRecord(Level.INFO, "Operation" + ",Transition," + "transition" + ",succeed");
            this.log.log(lr);
            this.logsaver.add(lr);
        });
        /*
    ...
    /**
     * A function that transit the atom structure information read from file to the
     * orbit system.
     */
    private void FromMapToOrbit() {
        ...
        int curtranum = 1;
        int numofeleonetra;
        double thetafortrack;
        Electron ele = null;
        for (Integer i : map.keySet()) {
            curtranum = i;
            numofeleonetra = map.get(i);
    ...
    void Draw() {
        ...
        circlepane.getChildren().add(nucircle);
     ...
     */
    void DrawOneOrbit(double radius, double maxrad, HashSet<Electron> aonetra, Map<Electron, Double> thetas,
            StringBuffer s) {
        // calculate radius

...
public class LogSaver {
	...
	/*Abstract function:
	 * 	1.log is the logger applications shares.
	 * 	2.loglist is a list of JavaLogElement which records the log events
	 * 	3.log saver is the instance in the singleton pattern
	 * 
	 */
	/*Rep Invariant:
	 * 	1.loglist中所有元素不能为null
	 */
	void checkRep() {
	...
	/**
	 * Get the logger in the instance of LogSaver,
	 *  which can be used to log the opereations.or exceptions.

...
public class LogSaver {
    ...
    /*
     * Abstract function: 1.log is the logger applications shares. 2.loglist is a
     * list of JavaLogElement which records the log events 3.log saver is the
     * instance in the singleton pattern
     * 
     */
    /*
    ...
    /**
     * Get the logger in the instance of LogSaver, which can be used to log the
     * opereations.or exceptions.
     * 
    ...
    private static LocalDateTime parseTimeString(String str) {
        ...
        return LocalDateTime.of(Integer.valueOf(dates[0]), Integer.valueOf(dates[1]), Integer.valueOf(dates[2]),
                Integer.valueOf(times[0]), Integer.valueOf(times[1]), Integer.valueOf(second[0]));
    }
}

...
public class CircularOrbitGUI extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		Pane leftp=new Pane();GridPane rightp=new GridPane();
		Circle c=new Circle();
		c.setStroke(Color.BLUE);c.setFill(null);
		...
		pane.getItems().addAll(leftp,rightp);
		leftp.getChildren().add(c);
		rightp.add(tf, 0, 0);rightp.add(b2, 3,0);
		...
		Button b1=new Button("RaceGame");Button b2=new Button("AtomStructure");
		Button b3=new Button("PersonalAppEcosystem");
		StackPane sp1=new StackPane();VBox sp2=new VBox();
		...
		sp1.getChildren().add(t);sp2.getChildren().addAll(b1,b2,b3);

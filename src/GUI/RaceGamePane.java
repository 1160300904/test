...
/**
 * This is the class of pane of TrackGame. The circular orbit of TrackGame will
 * be drawn on this pane.
 * 
...
public class RaceGamePane extends CircularOrbitPane<String, Athlete> {
    ...
    List<CircularOrbit<String, Athlete>> orbitlist = new ArrayList<>();// oribitlist that contains orbits.
    /*
     * Abstract function: 1.trackgame is used for generating the orbits of track
     * game. 2.arangeBut,setPlanBut,difBut,isLegalBut are buttons for users to use
     * to operate the GUI. 3.filechooser,stage is used for the user to choose
     * initial file of this system. 4.trackHandler is an exception handler handle
     * the exceptions in this system. 11.orbitlist contains the orbits generated
     * from TrackGame.
     */
    /*
     * Rep Invariant: none.
    ...
    RaceGamePane() {
        ...
        arangeBut.setOnAction(e -> {
            ...
            s.close();
            LogRecord lr = new LogRecord(Level.INFO, "Operation" + ",ArrangeGame," + inputtext + ",succeed");
            this.log.log(lr);
            this.logsaver.add(lr);
        });
    ...
    /**
     * A function that transit the plan information read from file to the orbit
     * system.
     */
     ...
     */
    void DrawOneOrbit(double radius, double maxrad, HashSet<Athlete> aonetra, Map<Athlete, Double> thetas,
            StringBuffer s) {
        // calculate radius
        ...
        for (Athlete a : aonetra) {
            ...
            s.append("At theta " + atheta + " : Athlete <" + a.getName() + "," + a.getNumber() + "," + a.getNation()
                    + "," + a.getAge() + "," + a.getBestScore() + ">\n");
         ...
         * c1.setRadius(3);c1.setFill(Color.YELLOW); l=new Label(String.valueOf(i),c);
         * l.setContentDisplay(ContentDisplay.RIGHT);

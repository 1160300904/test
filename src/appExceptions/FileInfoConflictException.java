...
/**
 * This is a class of one of the app Exceptions. If there is something in the initialize file which
 * conflicts with each other, then this exception will be thrown.
 * 

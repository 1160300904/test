...
public class CircularOrbitAPIs<L, E> {
  ...
  /**
   * Get the entropy of the input CircularOrbit system, basing on the distribution of the objects on
   * tracks.
   * 
  ...
  /**
   * Get the logical distance between two objects, which is the minimum number of edges that
   * connects two objects on track. if these two objects aren't connected, then return value is INF.
   * 
  ...
  /**
   * calculate the difference between two circular orbits. The defination of Difference is in the
   * Difference API.
   * 
   * @param c1 one of the circular orbit you want to calculate with.
   * @param c2 another circular orbit you want to calculate with.
   * @return the difference between two circular orbits. The definition of Difference is in the
   *         Difference API.
   */

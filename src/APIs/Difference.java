...
/**
 * This is an interface represents the difference of objects on two circular
 * orbit systems.
 * 
...
public interface Difference {
     ...
     * 
     * @param tracknum   The track number of the track you want to set your message
     *                   on.
    ...
    /**
     * Append the difference on object numbers on tracks between two circular
     * orbits.
     * 
     * @param objnumdiff the message of differences in numbers you want to put in.
     */
    ...
    /**
     * Append the difference on object details on tracks between two circular
     * orbits.
     * 
     * @param objdetaildiff the message of differences in details you want to put
     *                      in.
     */
     ...
     * @param tracknum   The track number of the track you want to set your message
     *                   on.
     * @param objnumdiff the message of differences in details you want to put in.
     */
     ...
     * 
     * @param objnumdiff the message of differences in numbers you want.
     */

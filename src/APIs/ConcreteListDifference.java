...
public class ConcreteListDifference implements Difference {
    ...
    /*
     * Abstract function: 1.TrackNumDiff is the difference on track numbers between
     * two circular orbits. if the first one has a tracks, and the second one has b
     * tracks, then the TrackNumDiff is a-b. 2.ObjNumDiff is a list consists of
     * object difference in number. On a particular track, if the first one has a
     * objects, and the second one has b tracks, then the ObjNumDiff is a-b.
     * 3.ObjDetailDiff is a list consists of object difference in details. On a
     * particular track, if the first one has objects {a,b,c}, and the second one
     * has objects {b,c,d,e}, then the ObjNumDiff is {a}-{d,e}.
     */
    /*
    ...
    public String toString() {
        ...
        if (this.ObjDetailDiff.size() == 0) {
            ...
            for (int i = 1; i <= tracknum; i++) {
                s.append("The difference of object detail on track " + i + " is : " + this.ObjDetailDiff.get(i - 1)
                        + "\n");
            }
        }

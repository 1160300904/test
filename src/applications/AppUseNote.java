...
/**
 * This is a class used to compose the using information during one period of the personal app
 * ecosystem.
 * 
...
public class AppUseNote implements Comparable<AppUseNote> {
  ...
  /*
   * Abstract function: 1.frequence means the frequency the app is used during this period. 2.time
   * means the total time the app is used during this period. 3.name means the name of the app.
   */
  /*
   * Rep Invariant: 1.frequence must be 0 or a positive number. 2.time must be 0 or a positive
   * number. 3.name cannot be an empty string.
   */
  void checkRep() {
    assert frequence >= 0;
    assert time >= 0;
